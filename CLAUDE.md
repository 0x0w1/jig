...
- A hotfix must name a matching item from `## 핫픽스 트리거` in `.jig/versioning.md`; `hotfix-flow` stops when nothing matches, and widening that list is a separate committed decision rather than a step inside a hotfix.
