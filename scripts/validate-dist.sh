...
require_text "dist/claude-code/.claude/skills/github-release/SKILL.md" 'do not add ordinary code, config, documentation, generated `dist`, or workflow changes in the release PR'
require_text "dist/codex/.agents/skills/github-release/SKILL.md" 'do not add ordinary code, config, documentation, generated `dist`, or workflow changes in the release PR'
require_text "dist/cursor/.cursor/rules/github-release.mdc" 'do not add ordinary code, config, documentation, generated `dist`, or workflow changes in the release PR'
require_text dist/codex/AGENTS.md 'do not add ordinary code, config, documentation, generated `dist`, or workflow changes in the release PR'
require_text dist/gemini-cli/GEMINI.md 'do not add ordinary code, config, documentation, generated `dist`, or workflow changes in the release PR'
require_text dist/opencode/AGENTS.md 'do not add ordinary code, config, documentation, generated `dist`, or workflow changes in the release PR'
